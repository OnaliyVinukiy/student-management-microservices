...
// add DBContext
var sqlConnectionString = builder.Configuration.GetConnectionString("StudentManagementCN");
...
{
    scope.ServiceProvider.GetService<StudentManagementDBContext>().MigrateDB();
}
