...
docker build -t student-management-system-dotnet-sdk-base:1.0 . -f dotnet-sdk-base-dockerfile

# Build the .NET runtime base image
docker build -t student-management-system-dotnet-runtime-base:1.0 . -f dotnet-runtime-base-dockerfile

# Build the .NET ASP.NET base image
docker build -t student-management-system-dotnet-aspnet-base:1.0 . -f dotnet-aspnet-base-dockerfile
